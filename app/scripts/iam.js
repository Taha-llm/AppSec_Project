...
var config = {
    client_id: "appsec",
    redirect_uri: "https://appsecproject.lme:8443/",
	registration_endpoint :"https://iam.appsecproject.lme:8443/rest-iam/register/authorize",
    authorization_endpoint: "https://iam.appsecproject.lme:8443/rest-iam/authorize",
    token_endpoint: "https://iam.appsecproject.lme:8443/rest-iam/oauth/token",
...
export function handleProfilName() {
    ...
    if (token) {
        ...
        fetch('https://iam.appsecproject.lme:8443/rest-iam/identities/profile', {
            method: 'GET',
            headers: {
